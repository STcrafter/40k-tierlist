...
В расчёты тирлиста, отчётов и веб-данных попадают только юниты стоимостью **не более 2000 очков**. Более дорогие модели по-прежнему разбираются адаптером, но исключаются из нормализации и перцентилей.
